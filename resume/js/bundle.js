...
const menu = (hamburgerSelector, menuSelector, hamburgerActive, menuActive) => {
    ...
    function toggleMenu() {
        ...
        menu.addEventListener('click', (e) => {
            ...
            if (target && target.classList.contains('menu__list')) {
                toggleMenu();
            }
        });
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const tabs = (tabsSelector, contentSelector, tabsParentSelector, activeClass) => {
