...
/***/ "./src/js/modules/scrollEffect.js":
/*!****************************************!*\
  !*** ./src/js/modules/scrollEffect.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_input__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/input */ "./src/js/modules/input.js");
/* harmony import */ var _modules_scrollEffect__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/scrollEffect */ "./src/js/modules/scrollEffect.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_2___default())('a[href*="#"]');
    ...
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide1', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide2', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide3', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide4', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide5', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide6', config).mount();
    new _glidejs_glide__WEBPACK_IMPORTED_MODULE_3__.default('.glide7', config).mount();

    // Меню 
    (0,_modules_menu__WEBPACK_IMPORTED_MODULE_4__.default)();

    // Показать все.
    (0,_modules_showmore__WEBPACK_IMPORTED_MODULE_5__.default)();

    // Только числа для INPUTA. 
    (0,_modules_input__WEBPACK_IMPORTED_MODULE_6__.default)();

    // Скролл эффект
    (0,_modules_scrollEffect__WEBPACK_IMPORTED_MODULE_7__.default)();
}); 
