...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const slider = (slidesSelector, prevSelector, nextSelector, slidesWrapperSelector, slidesFieldSelector) => {
    let offset = 0;
    let slideIndex = 1;
...
document.addEventListener('DOMContentLoaded', () => {
    (0,_modules_slider__WEBPACK_IMPORTED_MODULE_1__.default)('.promo__slide', '.prev', '.next', '.promo__slider-wrapper', '.promo__slider-inner');
    (0,_modules_menu__WEBPACK_IMPORTED_MODULE_0__.default)('.hamburger', '.menu__list', '.overlay', 'hamburger_active', 'menu__list_active', 'overlay_active');
