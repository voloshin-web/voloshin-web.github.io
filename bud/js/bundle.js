...
/* harmony export */ });
const tabs = () => {
    let tabHeader = document.querySelectorAll(".tabs__header")[0];
    let tabBody = document.querySelectorAll(".tabs__body")[0];
    
    let tabsPane = tabHeader.querySelectorAll(".tab");
    
    
     
    for (let i = 0; i < tabsPane.length; i++) {
        tabsPane[i].addEventListener("click",function(){
            tabHeader.getElementsByClassName("tab_active")[0].classList.remove("tab_active");
            tabsPane[i].classList.add("tab_active");
            tabBody.querySelector(".block_active").classList.remove("block_active");
            tabBody.querySelectorAll(".block")[i].classList.add("block_active");
        });
    }
};
...
window.addEventListener('DOMContentLoaded', () => {
    const rellax = new (rellax__WEBPACK_IMPORTED_MODULE_0___default())('.rellax');
    const rellaxin = document.querySelectorAll(".rellaxAbout");
    
    rellaxin.forEach(el => {
        const rellax = new (rellax__WEBPACK_IMPORTED_MODULE_0___default())(el, {
